...
public class Contract implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        com.ib.client.Contract retval = (com.ib.client.Contract)super.clone();
    ...
    public boolean equals(Object p_other) {
    	...
    	if (p_other == null || !(p_other instanceof com.ib.client.Contract)) {
    		return false;
    	}

        com.ib.client.Contract l_theOther = (com.ib.client.Contract)p_other;
