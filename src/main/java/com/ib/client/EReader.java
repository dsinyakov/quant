...
public class EReader extends Thread {
    ...
    private com.ib.client.EClientSocket m_parent;
    private DataInputStream m_dis;

    protected com.ib.client.EClientSocket parent()    { return m_parent; }
    private EWrapper eWrapper()         { return (EWrapper)parent().wrapper(); }

    public EReader(com.ib.client.EClientSocket parent, DataInputStream dis) {
