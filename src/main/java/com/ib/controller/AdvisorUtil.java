...
public class AdvisorUtil {
	...
	static ArrayList<com.ib.controller.Profile> getProfiles(String xml) {
		try {
	...
	static ArrayList<com.ib.controller.Profile> getProfiles_(String xml) throws IOException {
		ArrayList<com.ib.controller.Profile> list = new ArrayList<com.ib.controller.Profile>();

		com.ib.controller.Profile profile = null;
			...
			switch( state) {
				...
				case 1:
					if (line.equals( "<AllocationProfile>")) {
						profile = new com.ib.controller.Profile();
						state = 2;
					}
	...
	public static void main(String[] args) {
		...
		ArrayList<com.ib.controller.Profile> profiles = getProfiles( str2);
	...
	public static String getProfilesXml(ArrayList<com.ib.controller.Profile> profiles) {
		StringBuilder buf = new StringBuilder();
		buf.append( "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
