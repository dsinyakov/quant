...
public class ApiController implements EWrapper, Controller {
  ...
  public interface IAccountSummaryHandler {
    void accountSummary(String account, com.ib.controller.AccountSummaryTag tag, String value, String currency);
  ...
  public void reqAccountSummary(String group, com.ib.controller.AccountSummaryTag[] tags, IAccountSummaryHandler handler) {
    StringBuilder sb = new StringBuilder();
    for (com.ib.controller.AccountSummaryTag tag : tags) {
      if (sb.length() > 0) {
        sb.append( ',');
      }
      sb.append( tag);
  ...
  public interface ITopMktDataHandler {
    ...
    default void tickSize(NewTickType tickType, int size){}
    default void tickString(NewTickType tickType, String value){}
    default void tickSnapshotEnd(){}
    default void marketDataType(MktDataType marketDataType){}
  }
